...
docker pull 903120719010.dkr.ecr.us-east-1.amazonaws.com/digichlist-backend:latest;
docker run -ip 5000:5000 -d 903120719010.dkr.ecr.us-east-1.amazonaws.com/digichlist-backend:latest;
